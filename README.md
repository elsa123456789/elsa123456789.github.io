...
### 📈 AI & Data Strategy (4 projects)
- **Airbnb Superhost prediction** – Logistic regression + XGBoost, AUC ~74%, actionable host recommendations  
- **Credit Suisse crisis sentiment labeling** – 4,000+ news headlines, TextBlob rule‑based pipeline  
...
- **View Markdown files** – GitHub renders them automatically. Click any `.md` file to read.  
- **Download a single file** – Open the file, click `Raw` → right‑click → `Save as`.  
- **Download everything** – Click the green `<> Code` button → `Download ZIP`.  

All reports, code outputs, and images are included and can be downloaded directly.
